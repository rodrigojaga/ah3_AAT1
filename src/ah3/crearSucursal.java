...
public class crearSucursal extends javax.swing.JFrame {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(tcodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(tcodigo.getText().isEmpty()||tnombre.getText().isEmpty()||tdirec.getText().isEmpty()
                || tcorreo.getText().isEmpty()||ttelefono.getText().isEmpty()){
   ...
   public void listarSucursal(){
        try{
        sucursales.sucursal.add(new sucursales(Integer.parseInt(tcodigo.getText()),tnombre.getText(),
                tdirec.getText(),tcorreo.getText(),Integer.parseInt(ttelefono.getText())));
        
        usuarioPrincipal up = new usuarioPrincipal();
        up.setVisible(true);
        dispose();
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "HAS INGRESADO UN TIPO DE DATO INCORRECTO");
        }
    }
